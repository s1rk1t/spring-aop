...
public class MyDemoLoggingAspect {
	...
	public Object aroundGetFortune(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
		...
		// execute method and handle exception if thrown
		...
		try {
			...
			// log exception
			System.out.println("Exception thrown within getFortune() method: " + e.getMessage());
			// give user a customer message
			result = "Major accident, but no worries! Your private helicopter is on the way!";

			// if necessary to return exception to calling program, the exception can be
			// rethrown
			// ex: throw e;
